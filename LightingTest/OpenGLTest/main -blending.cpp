...
int main()
{
	...
	//=================shader================================
	Shader modelShader("../shader/blending.vert", "../shader/blending.frag");
	...
	std::string windowName = "window.png";
	LoadTexture cubeTexture(cubeName, GL_RGB, 1);
	LoadTexture floorTexture(floorName, GL_RGB, 1);
	LoadTexture windowTexture(windowName, GL_RGBA, 1, GL_CLAMP_TO_EDGE);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		{
			float dis = glm::length(camera.getPosition() - windows[i]);
			sorted[dis] = windows[i];
		}
		// render
		// ------
