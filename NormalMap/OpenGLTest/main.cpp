...
int main()
{
	...
	//=================shader================================
	Shader shader("../shader/normal_tex.vert", "../shader/normal_tex.frag");

	// set up vertex data (and buffer(s)) and configure vertex attributes
	
	unsigned int diffuseMap = loadTexture("../image/brickwall.jpg");
	unsigned int normalMap = loadTexture("../image/brickwall_normal.jpg");
...
void renderQuad()
{
	if (quadVAO == 0)
	{
		...
		bitangent1.x = inverse * (-deltaUV2.x * edge1.x + deltaUV1.x * edge2.x);
		bitangent1.y = inverse * (-deltaUV2.x * edge1.y + deltaUV1.x * edge2.y);
		bitangent1.z = inverse * (-deltaUV2.x * edge1.z + deltaUV1.x * edge2.z);
		...
		bitangent2.x = inverse * (-deltaUV2.x * edge1.x + deltaUV1.x * edge2.x);
		bitangent2.y = inverse * (-deltaUV2.x * edge1.y + deltaUV1.x * edge2.y);
		bitangent2.z = inverse * (-deltaUV2.x * edge1.z + deltaUV1.x * edge2.z);
