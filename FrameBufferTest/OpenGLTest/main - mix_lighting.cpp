...
int main()
{
	...
	//纹理图片处理
	std::string imageName_1 = "../image/container2.png";
	std::string imageName_2 = "../image/container2_specular.png";
	LoadTexture loadTexture1(imageName_1, GL_RGBA, 1);
	LoadTexture loadTexture2(imageName_2, GL_RGBA, 2);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		*/
		...
		loadTexture1.useTexture();
		loadTexture2.useTexture();
		// render the cube
		glBindVertexArray(cubeVAO);
